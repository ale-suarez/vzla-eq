...
Supabase magic links should be sent through Custom SMTP. For this project, use Resend in the Supabase dashboard:

- host: `smtp.resend.com`
- port: `465`
- username: `resend`
- password: the SMTP password generated by Resend

Set `RESEND_SMTP_PASSWORD` in your local `.env` when running the Supabase CLI locally.

Do not commit the SMTP password to the repo.
